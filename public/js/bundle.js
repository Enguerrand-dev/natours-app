...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false //center: [-118.264264, 34.125721],
    //zoom: 4
...
var stripe = Stripe('pk_test_51KcplvHIZxiA3tW8zDpZIDBPGCqoWWbC4CMsWdG3ivrEwoabL8sYLy5hx8sUKG9wP1hlTRM43yZxhsbz6MSrZCOy00js9HaGuF');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // SETTINGS
